...
public class UpdateActivity extends AppCompatActivity {
    ...
    Button updateButton;
    EditText updateDesc, updateLang, updateTitle;
    String desc , lang , title;
    String imageUrl;
    ...
    public void saveData(){
       storageReference = FirebaseStorage.getInstance().getReference().child("Android Image").child(uri.getLastPathSegment());
